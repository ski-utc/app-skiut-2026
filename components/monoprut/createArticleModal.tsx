...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, ScrollView, ActivityIndicator, KeyboardAvoidingView, Platform, Keyboard, Animated } from 'react-native';
                    ...
                    >
                        <View style={styles.modal}>
                            <View style={styles.header}>
                                ...
                                <TouchableOpacity style={styles.closeButton} onPress={() => animateClose(onClose)} disabled={loading}>
