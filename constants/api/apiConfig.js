const domains = {
  prod: "assos.utc.fr",
  dev: "192.168.1.201",  // IP du serveur de développement à changer pour chaque machine
  local: "127.0.0.1"
}
...
const urls = {
  ...
  dev: "http://192.168.1.201:8000/skiutc",  // IP du serveur de développement à changer pour chaque machine
