            ...
            try {
              ...
              if (response.success) {
                ...
                Toast.show({
                  ...
                  text1: 'Erreur',
                  text2:
                    response.message || "Impossible de réserver l'article.",
                });
              }
            } catch (error: unknown) {
            ...
            try {
              ...
              if (response.success) {
                ...
                Toast.show({
                  ...
                  text1: 'Erreur',
                  text2:
                    response.message || "Impossible de supprimer l'article.",
                });
              }
            } catch (error: unknown) {
              handleApiErrorToast(error, setUser);
  ...
  return (
    <View style={styles.card}>
      {!isMyOffer && !isReservation && (
        <View style={styles.iconContainer}>{getIconForType(article.type)}</View>
      )}
        ...
        {(isMyOffer || isReservation) && (
          <View style={styles.header}>
            <Text style={styles.productName}>
              {article.quantity} {article.product}
            </Text>
          </View>
        )}
        ...
        {isMyOffer && !article.receiver_room_id && (
          <View style={styles.roomInfo}>
            <Text style={styles.roomLabel}>
              Pas de grand succès pour l'instant ...
            </Text>
          </View>
        )}
      </View>
