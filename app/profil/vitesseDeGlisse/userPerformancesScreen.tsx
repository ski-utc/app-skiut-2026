...
export default function UserPerformancesScreen() {
  ...
  const fetchUserPerformances = useCallback(
    async (isRefresh = false) => {
      ...
      try {
        const response =
          await apiGet<UserPerformanceResponse>('user-performances');
          ...
          onPress: async () => {
            try {
              ...
              if (isSuccessResponse(response)) {
                ...
                Toast.show({
                  type: 'info',
                  text1: 'Suppression sauvegardée (Hors ligne)',
                });
              } else {
                Toast.show({
                  type: 'error',
      ...
      <View style={styles.sessionStats}>
        <View style={styles.sessionStat}>
          ...
          <Text style={styles.sessionStatValue}>
            {session.max_speed.toFixed(1)} km/h
          </Text>
        </View>
        ...
        <View style={styles.sessionStat}>
          ...
          <Text style={styles.sessionStatValue}>
            {session.average_speed.toFixed(1)} km/h
          </Text>
        </View>
  ...
  return (
    <View style={styles.container}>
      <Header
        refreshFunction={() => fetchUserPerformances(true)}
          ...
          {sessions.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyDescription}>
                Lancez votre première session pour voir vos performances
                apparaître ici
              </Text>
            </View>
          )}
