...
export default function CreateNotificationScreen() {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      ...
      const response = await apiPost<NotificationResponse>(
        'admin/notifications',
        payload,
      );
      if (response.success) {
            ...
            <View style={styles.typeSection}>
              ...
              <View style={styles.typeButtons}>
                <TouchableOpacity
                  style={[
                    styles.typeButton,
                    type === 'global' && styles.typeButtonActive,
                  ]}
                  onPress={() => setType('global')}
                >
                  <Globe
                    size={20}
                    color={type === 'global' ? Colors.white : Colors.primary}
                  />
                  <Text
                    style={[
                      styles.typeButtonText,
                      type === 'global' && styles.typeButtonTextActive,
                    ]}
                  >
                    Globale
                  </Text>
                ...
                >
                  <Users
                    size={20}
                    color={type === 'targeted' ? Colors.white : Colors.primary}
                  />
                  <Text
                    style={[
                      styles.typeButtonText,
                      type === 'targeted' && styles.typeButtonTextActive,
                    ]}
                  >
                    Ciblée
                  </Text>
                ...
                >
                  <Home
                    size={20}
                    color={
                      type === 'room_based' ? Colors.white : Colors.primary
                    }
                  />
                  <Text
                    style={[
                      styles.typeButtonText,
                      type === 'room_based' && styles.typeButtonTextActive,
                    ]}
                  >
                    Par chambre
                  </Text>
              ...
              <View style={styles.termsRow}>
                ...
                <View style={styles.termsTextContainer}>
                  <Text style={styles.termsText}>
                    Je certifie que cette notification respecte tous les
                    participants
                  </Text>
                </View>
              </View>
