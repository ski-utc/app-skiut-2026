...
// @ts-ignore
export default function ChallengeProof({ id, file, nbLikes, valid, alert, delete, authorId, roomId, challengeId, refresh, setError, setResponseMessage, setResponseSuccess, setShowBanner }) {
