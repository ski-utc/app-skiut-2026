const domains = {
  prod: "assos.utc.fr",
  dev: "192.168.1.203",  // IP du serveur de développement à changer pour chaque machine
  local: "127.0.0.1"
}
...
const urls = {
  ...
  dev: "http://192.168.1.203:8000/skiutc",  // IP du serveur de développement à changer pour chaque machine
